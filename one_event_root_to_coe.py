...
## Ryan Stuve
## Modified: 06/24/2022
## Extracts ET data from .root file, moves into individual .coe files for specified
...
if __name__ == "__main__":
    ...
    for i in etaSlices:
        ...
        for j in phiSlices:
            ...
            finalEt += t
        finalEt += '\n'
    with open(SaveDirName+'_input_data_event%s'% event + EXT, 'a') as f:
